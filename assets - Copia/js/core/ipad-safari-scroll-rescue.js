(function () {
  ...
  var clearShellState = function () {
    ...
    try { root.classList.add('doke-ipad-scroll-rescue-active'); } catch (_) {}
    try { body?.classList.add('doke-ipad-scroll-rescue-active'); } catch (_) {}
  };
  ...
  applyRescue();
  forcePaint();
  window.addEventListener('scroll', rescueTick, { passive: true });
  window.addEventListener('resize', rescueTick, { passive: true });
  window.addEventListener('orientationchange', rescueTick, { passive: true });
  window.visualViewport?.addEventListener('resize', rescueTick, { passive: true });
  window.visualViewport?.addEventListener('scroll', rescueTick, { passive: true });
  document.addEventListener('DOMContentLoaded', rescueTick, { once: true });
  window.addEventListener('load', rescueTick, { once: true });
})();
