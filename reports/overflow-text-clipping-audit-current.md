# Auditoria de overflow/text clipping — current

Total de ocorrências: **260**

## Por tipo

| Tipo | Ocorrências |
|---|---:|
| element-horizontal-overflow | 138 |
| badge-or-action-clipped | 48 |
| button-label-wrap | 39 |
| card-content-leak | 27 |
| text-or-content-clipping | 7 |
...
| index.html | 390x844 | element-horizontal-overflow | `strong.` | scrollWidth | <= 12 | 20 | 10 | não identificado |
| index.html | 390x844 | element-horizontal-overflow | `strong.doke-ad-card__price` | scrollWidth | <= 28 | 42 | 16 | não identificado |
| index.html | 390x844 | element-horizontal-overflow | `strong.` | scrollWidth | <= 13 | 20 | 9 | não identificado |
...
| index.html | 390x844 | card-content-leak | `div.doke-ad-card__body` | bounds | filho dentro do card | vazamento 16.33px | 16.33 | assets/css/pages/detalhe-anuncio.css; assets/css/components/layout/overflow-text-clipping-contract.css |
| index.html | 390x844 | card-content-leak | `div.doke-ad-card__body` | bounds | filho dentro do card | vazamento 16.33px | 16.33 | assets/css/pages/detalhe-anuncio.css; assets/css/components/layout/overflow-text-clipping-contract.css |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `div.content-rail.doke-scroll-rail.home-media-rail.home-media-rail--publications` | scrollWidth | <= 356 | 538 | 184 | não identificado |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `div.publication-grid.detail-related-publications__track` | scrollWidth | <= 356 | 538 | 184 | não identificado |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `div.doke-ad-card__tags` | scrollWidth | <= 68 | 86 | 20 | não identificado |
| detalhe-anuncio.html | 390x844 | text-or-content-clipping | `div.doke-ad-card__tags` | scrollHeight | <= 30 | 50 | 22 | não identificado |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `span.` | scrollWidth | <= 68 | 86 | 20 | não identificado |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `div.doke-ad-card__tags` | scrollWidth | <= 68 | 86 | 20 | não identificado |
| detalhe-anuncio.html | 390x844 | text-or-content-clipping | `div.doke-ad-card__tags` | scrollHeight | <= 30 | 50 | 22 | não identificado |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `span.` | scrollWidth | <= 68 | 86 | 20 | não identificado |
| detalhe-anuncio.html | 390x844 | element-horizontal-overflow | `div.doke-ad-card__tags` | scrollWidth | <= 68 | 86 | 20 | não identificado |
...
| detalhe-anuncio.html | 608x926 | element-horizontal-overflow | `div.content-rail.doke-scroll-rail.home-media-rail.home-media-rail--publications` | scrollWidth | <= 574 | 865 | 293 | não identificado |
| detalhe-anuncio.html | 608x926 | element-horizontal-overflow | `div.publication-grid.detail-related-publications__track` | scrollWidth | <= 574 | 865 | 293 | não identificado |
| detalhe-anuncio.html | 608x926 | element-horizontal-overflow | `div.detail-related-grid.detail-related-grid--ads.service-grid.service-grid--compact` | scrollWidth | <= 574 | 1744 | 1172 | não identificado |
...
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `div.doke-reviews-panel` | scrollWidth | <= 481 | 507 | 28 | não identificado |
...
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `span.doke-review-metric__label` | scrollWidth | <= 74 | 79 | 7 | não identificado |
...
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `span.doke-review-metric__label` | scrollWidth | <= 60 | 79 | 21 | não identificado |
...
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `span.doke-review-metric__label` | scrollWidth | <= 60 | 80 | 22 | não identificado |
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `div.doke-reviews-filter-row` | scrollWidth | <= 437 | 485 | 50 | não identificado |
...
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `span.doke-reviews-visible-count` | scrollWidth | <= 102 | 149 | 49 | não identificado |
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `div.detail-related-grid.detail-related-grid--ads.service-grid.service-grid--compact` | scrollWidth | <= 463 | 721 | 260 | não identificado |
| detalhe-anuncio.html | 810x1080 | element-horizontal-overflow | `strong.doke-ad-card__price` | scrollWidth | <= 42 | 70 | 30 | não identificado |
...
| comunidade.html | 810x1080 | element-horizontal-overflow | `button.doke-btn.communities-empty-v2__button.communities-empty-v2__button--create` | scrollWidth | <= 93 | 100 | 9 | não identificado |
...
| detalhe-anuncio.html | 1024x768 | element-horizontal-overflow | `div.doke-reviews-filter-row` | scrollWidth | <= 633 | 634 | 3 | não identificado |
...
| detalhe-anuncio.html | 1024x768 | element-horizontal-overflow | `div.detail-related-grid.detail-related-grid--ads.service-grid.service-grid--compact` | scrollWidth | <= 663 | 1022 | 361 | não identificado |
...
| index.html | 1280x800 | element-horizontal-overflow | `strong.doke-ad-card__price` | scrollWidth | <= 120 | 126 | 8 | não identificado |
...
| detalhe-anuncio.html | 1280x800 | element-horizontal-overflow | `div.doke-reviews-panel` | scrollWidth | <= 566 | 567 | 3 | não identificado |
...
| detalhe-anuncio.html | 1280x800 | element-horizontal-overflow | `span.doke-review-metric__label` | scrollWidth | <= 68 | 79 | 13 | não identificado |
...
| detalhe-anuncio.html | 1280x800 | element-horizontal-overflow | `span.doke-review-metric__label` | scrollWidth | <= 68 | 80 | 14 | não identificado |
| detalhe-anuncio.html | 1280x800 | element-horizontal-overflow | `div.doke-reviews-filter-row` | scrollWidth | <= 506 | 537 | 33 | não identificado |
...
| detalhe-anuncio.html | 1280x800 | element-horizontal-overflow | `span.doke-reviews-visible-count` | scrollWidth | <= 119 | 149 | 32 | não identificado |
| detalhe-anuncio.html | 1280x800 | element-horizontal-overflow | `div.detail-related-grid.detail-related-grid--ads.service-grid.service-grid--compact` | scrollWidth | <= 541 | 552 | 13 | não identificado |
