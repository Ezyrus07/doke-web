...
- Obtain the exact repository-only ANA-A07/A09 runtime projection authority authorization bound to the then-current PR HEAD and certified canary staging evidence blob 3b7274a391a857f2de06538f3302f6be01b06734; keep runtime snapshot and snapshot publication authority false.
...
_Documento gerado de forma determinística a partir de `config/domain-completion-matrix.json`. Baseline: 2026-09-25T13:38:00.000Z._
