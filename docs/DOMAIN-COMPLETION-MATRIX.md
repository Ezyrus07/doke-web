...
- Obtain a fresh ANA-A07/A09 controlled staging canary authorization against the post-remediation PR HEAD, with identityAuthority=seed002-email-resolved; then execute validation 046 plus the transient second-session late-fact protocol with mandatory cleanup and no maturity promotion.
