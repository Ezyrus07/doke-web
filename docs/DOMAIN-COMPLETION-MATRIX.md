...
- Create and approve a repository-only activation envelope for ana-a07-a09-funnel-v1-r1 with an explicit effectiveFrom/effectiveUntil and immutable evidence binding; do not invoke policy activation, publish snapshots or run content canaries in that lot.
...
_Documento gerado de forma determinística a partir de `config/domain-completion-matrix.json`. Baseline: 2026-09-24T00:57:37.595619Z._
