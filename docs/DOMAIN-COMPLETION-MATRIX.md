...
- Obtain the exact single-use ANA-A07/A09 persistent-activation staging authorization bound to the then-current PR HEAD, successor staging evidence blob 02a860c812eeb777519c7917bb5c31b3fb3dd5e2, activation approval evidence and approved effective window; do not infer this authority from generic proceed.
...
_Documento gerado de forma determinística a partir de `config/domain-completion-matrix.json`. Baseline: 2026-09-25T11:30:18.597832Z._
