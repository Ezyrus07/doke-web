...
- Apply the ANA-A07/A09 approved activation successor candidate in staging under a separate explicit authorization and execute validation 045 rollback-only; this staging-structure lot must not persist the eight policies outside rollback.
...
_Documento gerado de forma determinística a partir de `config/domain-completion-matrix.json`. Baseline: 2026-09-24T14:43:00.000Z._
