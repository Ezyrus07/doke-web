...
- Obtain explicit ANA-A07/A09 repository-only activation-approval authorization using the exact contract command bound to the then-current PR HEAD; this command must not authorize staging application, activation invocation or policy persistence.
