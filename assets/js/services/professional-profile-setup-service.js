...
(function () {
  ...
  function rpc(name,args){var api=window.DokeSupabase;if(!api||typeof api.invokeSelfService!=='function')return Promise.reject(new Error('Autoridade self-service indisponível para salvar o perfil profissional.'));return api.invokeSelfService(name,args||{});}
