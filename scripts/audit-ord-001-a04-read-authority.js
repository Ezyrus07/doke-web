...
const a05Recorded = ord.requiredPaths.includes('docs/validation/ORD-001-A05-COMMAND-ACTIVATION.json');
const historicalDescription = blocker && blocker.description.includes('Submitted commands');
const a05Description = a05Recorded && blocker && /real|browser|two-account|duas contas/i.test(blocker.description);
assert(historicalDescription || a05Description, 'ORD-B02 must describe the remaining command activation gap.');
