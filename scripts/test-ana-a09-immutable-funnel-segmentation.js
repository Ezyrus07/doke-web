...
const serviceId='00000000-0000-4000-8000-000000000111';
const coverage='2026-09-23T00:06:30.6835Z';
const rows=[
  {serviceId,sequenceNo:1,occurredAt:'2026-09-23T00:06:30.6835Z',eligibleAfter:true,dimensionSnapshotAfter:{category:'Limpeza',state:'ba'}},
  {serviceId,sequenceNo:2,occurredAt:'2026-09-23T00:10:00Z',eligibleAfter:true,dimensionSnapshotAfter:{categoryId:'17263173-c179-455f-bd43-2c3d9a55a8fd',categorySlug:'limpeza',category:'Limpeza',state:'BA'}},
  {serviceId,sequenceNo:3,occurredAt:'2026-09-23T00:10:00Z',eligibleAfter:true,dimensionSnapshotAfter:{categoryId:'27263173-c179-455f-bd43-2c3d9a55a8fd',categorySlug:'reparos',category:'Reparos',state:'sp'}},
  {serviceId,sequenceNo:4,occurredAt:'2026-09-23T00:20:00Z',eligibleAfter:false,dimensionSnapshotAfter:null}
];
...
const incomplete=[{serviceId,sequenceNo:1,occurredAt:coverage,eligibleAfter:true,dimensionSnapshotAfter:{category:'Limpeza',state:''}}];
...
let bad=false;try{s.resolveFrozenSegment([
 {serviceId,sequenceNo:1,occurredAt:'2026-09-23T00:08:00Z',eligibleAfter:true,dimensionSnapshotAfter:{category:'A',state:'BA'}},
 {serviceId,sequenceNo:2,occurredAt:'2026-09-23T00:07:00Z',eligibleAfter:true,dimensionSnapshotAfter:{category:'B',state:'BA'}}
...
bad=false;try{s.validateServiceLedger([
 {serviceId,sequenceNo:1,occurredAt:'2026-09-23T00:07:00Z',eligibleAfter:true,dimensionSnapshotAfter:{category:'A',state:'BA'}},
 {serviceId,sequenceNo:3,occurredAt:'2026-09-23T00:08:00Z',eligibleAfter:true,dimensionSnapshotAfter:{category:'B',state:'BA'}}
],serviceId);}catch(e){bad=e.message==='ANA_A09_SEGMENT_LEDGER_SEQUENCE_INVALID';}
