...
check('validation 041 pass recorded',c.status==='validation_041_pass_concurrency_canary_pending'&&c.repositoryEvidence?.migrationApplied===true&&c.repositoryEvidence?.stagingValidated===false&&c.repositoryEvidence?.stagingMigrationVersion==='20260923230106'&&c.repositoryEvidence?.compatibilityMigrationApplied===true&&c.repositoryEvidence?.compatibilityStagingMigrationVersion==='20260923231132'&&c.validationPlan?.validation041Status==='passed'&&c.repositoryEvidence?.structuralValidation041Passed===true);
...
check('runtime evidence bound',c.runtimeEvidence?.artifact==='reports/generated/ana-a07-watermark-compatibility-runtime-evidence.json'&&c.runtimeEvidence?.status==='validation_041_pass_concurrency_pending'&&c.runtimeEvidence?.concurrentWriterCertified===false&&c.runtimeEvidence?.lateFactCertified===false);
