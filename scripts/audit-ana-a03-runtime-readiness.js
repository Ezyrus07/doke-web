...
['private.analytics_behavior_events_v1','record_analytics_behavior_event_v1','semantic_key text not null unique','DOKE_ANALYTICS_IDEMPOTENCY_CONFLICT'].forEach(x=>check('migration '+x,migration.includes(x)));
