...
check('search current key env support',search.includes('SUPABASE_PUBLISHABLE_KEYS')&&search.includes('SUPABASE_SECRET_KEYS'));check('search proof integration',search.includes('attachAnalyticsExposureProofs'));check('search executed projection',search.includes('recordSearchExecuted'));check('detail search proof verification',edge.includes('DOKE_ANALYTICS_EXPOSURE_MISMATCH')&&edge.includes('searchRequestId, serviceId'));
