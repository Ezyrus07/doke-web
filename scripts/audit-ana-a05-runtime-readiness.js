...
check('timestamp compare correct',sql.includes('s.created_at is distinct from p.occurred_at'));check('dimension compare implemented',sql.includes("s.payload ->> 'serviceId'")&&sql.includes('v_dimension_mismatch'));
