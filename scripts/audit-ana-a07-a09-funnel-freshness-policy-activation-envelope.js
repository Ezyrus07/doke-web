...
assert.equal(envelope.status,'effective_window_active_persistent_policy_rows_8_runtime_canary_contract_ready_staging_unauthorized');
...
assert.equal(envelope.activationInvocationContract.status,'runtime_canary_contract_repository_ready_staging_execution_unauthorized');
