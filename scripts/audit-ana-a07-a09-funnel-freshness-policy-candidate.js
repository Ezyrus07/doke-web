...
check('uniform active r1',c.policies.every(p=>p.metricVersion==='v1'&&p.maxLagSeconds===360&&p.status==='active_runtime_canaries_certified_repository_projection_authority_granted'&&p.effectiveFrom==='2026-09-24T14:00:00Z'&&p.effectiveUntil===null));
