...
check('scheduler activation authorization consumed',c.pendingAuthorityDecisions.scheduler.currentlyAuthorized===false&&c.pendingAuthorityDecisions.scheduler.resolved===true&&c.pendingAuthorityDecisions.scheduler.schedulerActivated===true&&c.pendingAuthorityDecisions.scheduler.jobId===8&&c.pendingAuthorityDecisions.scheduler.activationAuthorizationConsumed===true);
check('scheduler candidate is persistently active in staging',c.schedulerActivationCandidate.status==='staging_scheduler_active_policy_effective_runtime_certified'&&c.schedulerActivationCandidate.stagingApplied===true&&c.schedulerActivationCandidate.stagingMigrationVersion==='20260923144627'&&c.schedulerActivationCandidate.validation040Passed===true&&c.schedulerActivationCandidate.schedulerActivated===true&&c.schedulerActivationCandidate.activationAuthorizationConsumed===true&&c.schedulerActivationCandidate.persistentRuntime.relevantCronCount===1&&c.schedulerActivationCandidate.persistentRuntime.jobId===8&&c.authority.schedulerActivationCandidateAuthority===true&&c.authority.schedulerActivationCandidateRuntimeAuthority===true&&c.authority.schedulerRuntimeAuthority===true&&c.authority.schedulerActivationAuthority===false);
...
check('scheduler rollback evidence leaves zero cron',c.schedulerActivationCandidate.rollbackValidation.firstActivationStatus==='APPENDED'&&c.schedulerActivationCandidate.rollbackValidation.replayStatus==='NO_CHANGE'&&c.schedulerActivationCandidate.rollbackValidation.rolledBack===true&&c.schedulerActivationCandidate.rollbackValidation.persistentCronJobsAfterRollback===0);
check('scheduler real pre-effective runs succeed safely',c.schedulerActivationCandidate.persistentRuntime.preEffectiveRuns.length===2&&c.schedulerActivationCandidate.persistentRuntime.preEffectiveRuns.every(r=>r.status==='succeeded')&&c.schedulerActivationCandidate.persistentRuntime.preEffectivePlannerReturnedNoWindows===true&&c.schedulerActivationCandidate.persistentRuntime.preEffectivePostPolicySnapshotCount===0);
check('scheduler post-effective proof certified',c.status==='post_effective_runtime_certified'&&c.pendingRuntimeEvidence.schedulerPostEffective.status==='certified_read_only'&&c.pendingRuntimeEvidence.schedulerPostEffective.result==='PASS'&&c.runtimeCertification.status==='PASS'&&c.runtimeCertification.firstCanonicalWindowMaterialized===true&&c.runtimeCertification.requiredSeriesCovered===true&&c.runtimeCertification.duplicateSnapshotKeys===0&&c.runtimeCertification.maxObservedCompletionDelaySeconds<60&&c.runtimeCertification.olderWindowFallbackUsed===false&&c.runtimeCertification.anaMaturityAfter===3);
