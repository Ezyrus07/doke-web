...
const pages = PRODUCT_PAGES.map((page) => {
  ...
  const provisional = ['carteira.html','detalhe-anuncio.html','resultados.html','pagamento-profissional.html','configuracoes.html','comunidade.html'].includes(page);
  const issues = [];
...
const groups = {
  ...
  operationalTransactional: ['pedidos.html','carteira.html','pagamento-profissional.html','configuracoes.html','notificacoes.html'],
