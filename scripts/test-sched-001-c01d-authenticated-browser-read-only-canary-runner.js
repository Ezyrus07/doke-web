...
assert(preparerSource.includes("path: localSupabaseUmd"));
assert(preparerSource.includes("contentType: 'application/javascript'"));
assert(preparerSource.includes("checkpoint('orders_supabase_cdn_localized')"));
