...
assert.equal(c.status,'runtime_canary_identity_and_service_eligibility_remediated_staging_execution_unauthorized');
...
assert.equal(c.runtimeCanaryContractAuthorization.contractStatus,'repository_ready_identity_and_service_eligibility_remediated_staging_execution_unauthorized');
...
assert(ana.nextActions.some(a=>a.includes('controlled staging canary authorization')));
