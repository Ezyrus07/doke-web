...
assert.equal(c.status,'runtime_canary_contract_repository_ready_staging_execution_unauthorized');
...
assert.equal(c.runtimeCanaryContractAuthorization.contractStatus,'repository_ready_staging_execution_unauthorized');
