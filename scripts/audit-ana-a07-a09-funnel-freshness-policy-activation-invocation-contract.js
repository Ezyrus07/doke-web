...
assert.equal(c.status,'runtime_canary_identity_remediated_staging_execution_unauthorized');
...
assert.equal(c.runtimeCanaryContractAuthorization.contractStatus,'repository_ready_identity_remediated_staging_execution_unauthorized');
