...
assert.equal(c.runtimeCanaryContractAuthorization.stagingCanaryEvidenceBlobSha,'3b7274a391a857f2de06538f3302f6be01b06734');
assert.equal(c.runtimeCanaryContractAuthorization.validation046Status,'PASS');
assert.equal(c.runtimeCanaryContractAuthorization.lateFactStatus,'PASS');
assert.equal(c.runtimeCanaryContractAuthorization.cleanupStatus,'PASS');
...
assert(ana.nextActions.some(a=>a.includes('runtime projection authority')));
