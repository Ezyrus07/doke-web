...
check('canonical window grid unset',c.canonicalWindowGrid?.status==='pending_versioned_window_grid'&&c.canonicalWindowGrid?.windowStepSeconds===null&&c.canonicalWindowGrid?.boundaryAnchor===null&&c.canonicalWindowGrid?.boundaryTimeZone==='not_applicable_fixed_duration_grid'&&c.canonicalWindowGrid?.timeZoneIsIndependentAuthority===false);
