...
if (residualRows.length !== 47 || total !== 1280 || highDead !== 0 || targetState.decl !== 710 || targetState.dead !== 0) throw new Error(`residual ${residualRows.length}/${total}/${highDead}/${targetState.decl}/${targetState.dead}`);
console.log('PERMANENT RESIDUAL PASS|active=401|high=37|files=47|dead=1280|highDead=0|target=710/dead0');
