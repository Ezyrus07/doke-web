...
if (residualRows.length !== 46 || total !== 1274 || highDead !== 0 || targetState.decl !== 366 || targetState.dead !== 0) throw new Error(`residual ${residualRows.length}/${total}/${highDead}/${targetState.decl}/${targetState.dead}`);
console.log('PERMANENT RESIDUAL PASS|active=401|high=37|files=46|dead=1274|highDead=0|target=366/dead0');
