...
(async () => {
  ...
  const window = {
    location: {
      href: 'https://doke.example/auth/redefinir-senha.html#type=recovery&access_token=secret',
      search: '',
  ...
  assert.strictEqual(recoveryRequests[0].options.redirectTo, 'https://doke.example/auth/redefinir-senha.html');
