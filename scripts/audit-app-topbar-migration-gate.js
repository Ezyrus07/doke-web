...
const TARGETS = ['index.html','resultados.html','perfil.html','pedidos.html','carteira.html','pagamento-profissional.html','configuracoes.html','notificacoes.html','comunidade.html','comunidade.html'];
const failures = [];
const pages = [];
