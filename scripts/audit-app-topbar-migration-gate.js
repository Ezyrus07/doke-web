...
const TARGETS = ['index.html','resultados.html','perfil.html','pedidos.html','carteira.html','pagamento-profissional.html','avaliacao.html','configuracoes.html','notificacoes.html','comunidade.html','comunidade-interna.html'];
const failures = [];
const pages = [];
