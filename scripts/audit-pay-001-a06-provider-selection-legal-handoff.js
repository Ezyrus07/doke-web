...
assert(["PAY-A08","PAY-A09","PAY-A10","PAY-A11","PAY-A12","PAY-A13","PAY-A14"].some((sublot) => pay.nextActions[0].includes(sublot)), "PAY successor must remain monotonic after PAY-A10");
