...
check('A07 dependency',c.freshnessDependency?.contract==='ANA-A07'&&a07.contractId==='ana-a07-freshness-window-authority-v1');check('watermark handoff bound',c.freshnessDependency?.watermarkContractId===watermark.contractId&&c.freshnessDependency?.status==='runtime_watermark_candidate_ready_staging_unapplied'&&c.freshnessDependency?.behaviorMaterializationTime==='received_at'&&c.freshnessDependency?.orderMaterializationTime==='created_at'&&c.freshnessDependency?.runtimeCandidatePath==='config/ana-a07-behavior-ord-watermark-runtime-readiness.json');check('watermark runtime still blocked',c.freshnessDependency?.runtimeFreshnessActivationStillBlocked===true&&watermark.runtimeCandidate?.migrationApplied===false);check('liquidity no longer A09 blocker',c.catLiquidityBlocker?.status==='liquidity_runtime_closed_outside_a09');
