...
check('immutable segmentation candidate bound',segmentation.contractId==='ana-a09-immutable-funnel-segmentation-v1'&&segmentation.scope==='repository_only_runtime_candidate'&&segmentation.status==='repository_runtime_candidate_prepared_unapplied'&&segmentation.authority?.repositoryContractAuthority===true&&segmentation.authority?.runtimeSegmentationAuthority===false&&segmentation.repositoryRuntimeCandidate?.migrationApplied===false&&segmentation.repositoryRuntimeCandidate?.stagingValidated===false&&c.segmentation?.immutableSegmentationContract?.contractId===segmentation.contractId&&c.segmentation?.immutableSegmentationContract?.runtimeCandidate?.validation047Status==='pending'&&c.segmentation?.currentAuthority==='global_only_for_behavioral_stages'&&c.segmentation?.mutableCurrentServiceJoinAllowed===false);
