...
const PREDECESSOR_HEAD = 'b3ac2f9e03509ace9c136031566388d7d22d64c7';
const PREDECESSOR_TREE = 'ce909ee45af929445617e8460e3168558cc6fbfb';
const PREDECESSOR_CERTIFICATION_RUN_ID = 32646484921;
const PREDECESSOR_CERTIFICATION_JOB_ID = 97211419375;
...
const AUTHORIZATION_KIND = 'single_use_repository_only_deterministic_synthetic_invocation_harness_materialization';
const AUTHORIZATION_SOURCE = 'user_explicit_authorization_com_001_post_b02ca_deterministic_synthetic_invocation_harness_materialization';
const NEXT_ACTION = 'stop_and_require_fresh_explicit_authorization_before_any_deterministic_repository_only_synthetic_operation_method_invocation_or_continuation_state_storage_registry_execution_or_sensitive_scope';
...
function evaluateBoundaryCertification(packet) {
  ...
  req(isObject(authority) && authority.kind === AUTHORIZATION_KIND,
    'FRESH_SINGLE_USE_SYNTHETIC_HARNESS_AUTHORIZATION_KIND_REQUIRED');
  req(isObject(authority) && authority.source === AUTHORIZATION_SOURCE,
    'FRESH_SINGLE_USE_SYNTHETIC_HARNESS_AUTHORIZATION_SOURCE_REQUIRED');
  req(isObject(authority) && authority.singleUse === true,
    'FRESH_SINGLE_USE_SYNTHETIC_HARNESS_AUTHORIZATION_SINGLE_USE_REQUIRED');
  req(isObject(authority) && authority.reusable === false,
    'FRESH_SINGLE_USE_SYNTHETIC_HARNESS_AUTHORIZATION_REUSABLE_FALSE_REQUIRED');
