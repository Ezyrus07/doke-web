...
comment on function public.cleanup_order_canary_run(text) is
  'ORD-A06 service-role-only cleanup boundary for one doubly marked visual-settlement canary order. Aborts on partial markers, ambiguous scope, advanced lifecycle states, or dependencies outside ORD-001.';
